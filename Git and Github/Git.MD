...
> Przeglądanie i odzyskiwanie referencji ze zmian
...
`git reset` możemy również użyć w sytuacji gdy wprowadziliśmy już zmiany do indeksu za pomocą `git add` i chcemy je wycofać.
